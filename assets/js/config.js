...
(function (SN) {
    ...
    worldbook: [
      {
        ...
        title: "世界观 · 星海列车",
        category: "世界观",
        content: "一条穿过星海的夜间列车，每站停靠时都会有一段故事。"
      },
      { id: "w2", title: "主角设定", category: "角色", content: "29 岁，习惯性熬夜，喜欢在阳台吹风。" },
      { id: "w3", title: "语言风格", category: "规则", content: "回复简短自然，像微信聊天，不要长篇大论。" }
    ],
  ...
  SN.defaults.chats = {
    ...
    xingye: [{ role: "them", text: "欢迎回来！我今天学会了一个新笑话，要听吗？", time: "21:40" }],
    yohang: [{ role: "them", text: "现在是深夜电台时间，我在听。", time: "23:12" }]
  };
})(window.SN);